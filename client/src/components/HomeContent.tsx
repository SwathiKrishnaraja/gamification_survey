      ...
      <div onClick={handleClickOutsideModal} id="modal" data-testid='intro-content' className="main-body">
        <div>
          ...
          <p style={{ textAlign: 'left' }}>
            I would like to invite you to this research project, which is a part of a Master Thesis performed, at the Saarland University, Germany.  We are very much interested in learning about your perspectives about <b>sports and leisure activities.</b>
          </p>
          <p style={{ textAlign: 'left' }}>
            Please answer the questions as honestly as possible.  Please note that you will not be requested for any information that could identify you personally – for us, the most important thing is that we learn about your thoughts and perspectives. Additionally, all your data will be kept <b>anonymous and confidential</b> and cannot be traced back to you.
          </p>
          <p style={{ textAlign: 'left' }}>
